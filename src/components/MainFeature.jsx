                    ...
                    >
                      ...
                      <div className="flex justify-between items-center">
                        <div className="flex items-center">
                          ...
                          {/* Project tag */}
                          {task.projectId && (
                            <span className="inline-flex items-center text-xs px-2 py-0.5 rounded ml-2" style={{ backgroundColor: `${projects.find(p => p.id === task.projectId)?.color}20`, color: projects.find(p => p.id === task.projectId)?.color }}>
